...
raw_gold = paths_cfg.get("feature_gold_dir", "data/gold")
resolved_gold = _resolve_dir(raw_gold, "data/gold")
if not resolved_gold.endswith("feature_store") and os.path.exists(os.path.join(resolved_gold, "feature_store")):
    GOLD_PATH = os.path.join(resolved_gold, "feature_store")
else:
    GOLD_PATH = resolved_gold

MODEL_DIR   = _resolve_dir(paths_cfg.get("models_dir", "models"), "models")
